...
<link
	...
	href="<?php echo $tplDisplayFront['FEED_URL'] ?>" />
...
if(!JModuleHelper::isEnabled('maiancart')){?>
	<a id="mm_cart"
		...
		<img
		src="components/com_maianmedia/<?php echo getTplPath($this->skin_name, 'img')?>/icons/shopping_cart.png" />
	...
	<div id="mm_navigation">
		<ul>
		<?php if(isset($tplDisplayFront['f_display']) && $tplDisplayFront['f_display'] != '0'){ ?>
			<li id="mm_free_url"><a
				href="<?php echo $tplDisplayFront['F_URL'] ?>"
				title="<?php echo $tplDisplayFront['FREE']; ?>"><?php echo $tplDisplayFront['FREE']; ?>
			</a></li>
			<?php } ?>
			<?php if(isset($tplDisplayFront['p_display']) && $tplDisplayFront['p_display'] != '0'){ ?>
			...
			<?php } ?>
			<?php if(isset($tplDisplayFront['m_display']) && $tplDisplayFront['m_display'] != '0'){ ?>
			...
			<?php } ?>
			<?php if(isset($tplDisplayFront['c_display']) && $tplDisplayFront['c_display'] != '0'){ ?>
			...
			<?php } ?>
			<?php if(isset($tplDisplayFront['l_display']) && $tplDisplayFront['l_display'] != '0'){ ?>
