...
var FileManager = new Class({
  ...
  download: function(e) {
    e.stop();
    if (!this.Current) return false;
  //Update Alao needed to convert ? since i am passing a session id
...
Asset.javascript(__DIR__+'../js/milkbox/milkbox.js');
Asset.css(__DIR__+'../js/milkbox/css/milkbox.css');
Asset.css(__DIR__+'../Css/FileManager.css');
Asset.css(__DIR__+'../Css/Additions.css');
Asset.javascript(__DIR__+'../js/jsGET.js', { events: {load: (function(){ window.fireEvent('jsGETloaded'); }).bind(this)}});
