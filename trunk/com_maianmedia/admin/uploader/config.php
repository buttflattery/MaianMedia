...
// for upload
  ...
  'hijackForm'              => false,                                    // if true Uploader will try to "hijack" enclosing form 
...
// not to overwrite an existing file
  ...
  'configUrl'               => '../uploader/uploader.xml',                          // a relative or absolute URL to Uploader frontend config 
...
// set to true
  ...
  'uploadDir'               => '%APPDIR%/tmp/',                     // a directory to put uploaded files into; it is strongly 
...
// Uploader was instaled to
  ...
  'tmpDir'                  => '%APPDIR%/tmp/tmp',                         // a directory to put temporary files into; aplicable only 
