...
/*------------------------------------------
 CUSTOM LANGUAGE FILE FOR THE ZOO TEMPLATE
 -------------------------------------------*/
...
define( '_msg_public_header2','Items in Cart');
define( '_msg_public_header3','Most Popular');
define( '_msg_public_header4','Catalog');
...
define( '_msg_public_header12','License');
...
define( '_msg_publicalbum','Preview/Purchase Tracks');
...
define( '_msg_publicalbum3','Preview');
define( '_msg_publicalbum4','Add to Cart');
define( '_msg_publicalbum5','Track');
define( '_msg_publicalbum6','Cost');
define( '_msg_publicalbum7','Add to Cart');
/* FA Changed */
define( '_msg_publicalbum8','Add Full Album to Cart');
define( '_msg_publicalbum9','Add Selected Tracks to Cart');
define( '_msg_publicalbum10','Preview Tracks');
define( '_msg_publicalbum11','Track');
define( '_msg_publicalbum12','This page has been viewed <b>{count}</b> times.');
define( '_msg_publicalbum13','Save <b>{amount}</b> %');
define( '_msg_publicalbum14','Related Albums');
define( '_msg_time','Time');
define( '_msg_buytrack','+Add');
...
define( '_msg_cart','Shopping Cart');
define( '_msg_cart2','The items currently in your cart are shown below. Use the buttons provided if you wish to remove any items. When you are happy with your selections, click \'Checkout\' to proceed:');
define( '_msg_cart3','There are currently 0 items in your cart.');
define( '_msg_cart4','{count} Shopping Cart Items');
define( '_msg_cart5','Total');
define( '_msg_cart6','Clear Cart');
define( '_msg_cart7','Checkout');
define( '_msg_cart8','From:');
/* define( '_msg_cart9','You Save {discount}%');  */
define( '_msg_cart9','Complete Album');
define( '_msg_cart10','View Your Cart');
...
define('_msg_publichome3','Most Popular Tracks');
define('_msg_publichome4','Most Popular Albums');
...
define('_msg_downloaditem','<br /><br /><span class="sorry">Sorry!</span><br /><br /><span class="sorry_msg">This Download Has Expired!</span><br /><br /><br />Please use the contact option<br />to have this download reset.');
define('_msg_downloaditem2','<br /><br /><span class="sorry">Error!</span><br /><br /><span class="sorry_msg">You do not have permission<br />to view this page!</span><br /><br /><br />Please use the contact option<br />if you think this is incorrect.');
...
define('_msg_music','Click the title or album cover to view album information, and preview or purchase the album or individual tracks.<br />All of our audio downloads are in the lossless, CD quality <b>FLAC</b> format, which can be easily converted to any other format. ');
define('_msg_music2','More Information');
...
define('_msg_paypal','Connecting to Paypal server.....Please wait....');
define('_msg_paypal2','Music Store Purchases');
define('_msg_paypal3','Transaction Cancelled!');
define('_msg_paypal4','Your transaction was successfully cancelled and no payment was sent.<br /><br />Thank you for your interest in our music.');
define('_msg_paypal5','Invalid Transaction!');
...
define('_msg_paypal8','Your transaction has successfully been completed.<br /><br />
                              Please check your inbox for "<b>{email}</b>". This message contains a download link to the audio files you purchased. Please click this link to go to the download page. If you do not receive this e-mail, please contact us via the link in the left hand menu.<br /><br />
                              We hope you enjoy the music,<br /><br />
                              <b>{store}</b>');
...
define('_msg_paypal15','<p>Thank you for your purchases, your downloads are shown below. Single tracks are FLAC format. Full album purchases may be downloaded as FLAC (single tracks or full album ZIP) or ALC (Apple Lossless, iTunes compatible, full album zip only.) For information on how to convert FLAC to other formats, please <a href="index.php?option=com_content&view=article&id=100&Itemid=101" class="modal">click here.</a>
</p>

<p> Please <b>DO NOT</b> refresh or bookmark this page as it may timeout or have expired when you return.</p>

<p>You may download each file {duration}.<br />
Please note that the files can be very large and take a very long time to download. Please be patient and do not his the download icon more than once before the file begins to download. If you experience any problems, please use the contact link in the menu.</p>');                              
...
define('_msg_paypal23','Thank you for purchasing audiophile recordings from furious artisans.');
define('_msg_paypal24','Download Track');
/* define('_msg_paypal25','Download Artwork'); */
define('_msg_paypal25','Download Apple Lossless (iTunes) Version');
...
define('_msg_paypalf50','Apple Lossless');
...
define('_msg_publicsearch','Search Results');
define('_msg_publicsearch2','Your search results for "<b>{keywords}</b>" are shown below. If your search generated no results, try multiple keywords seperated by a space for a more detailed search.');
define('_msg_publicsearch3','<br /><b>No Results Found...Please Try Again...</b>');
define('_msg_publicsearch4','{count} Search Results');
...
/* Changed */
define('_msg_add8','Download File Path');
...
define('_msg_albums','Audio files are grouped into albums. When you add tracks, you`ll
...
/* fa modified */
define('_msg_albums6','Apple Lossless Zip File');
...
define('_msg_albums19','Album Price/Discount');
...
define('_msg_script2','Yes');
define('_msg_script3','No');
define('_msg_script4','Optional');
define('_msg_script5','First');
define('_msg_script6','Last');
define('_msg_script7','Edit');
define('_msg_script8','Delete');
define('_msg_script9','Cancel');
define('_msg_script10','Refresh');
define('_msg_script11','Print');
define('_msg_script12','unlimited');
...
define('_msg_albums23', 'Album In Cart');
...
define('_msg_download_message','For your convenience, a link to the download page is provided below');
...
/* Note: RM Changed to Catalog */
define('_msg_RM','Catalog Number');
/* Note: UPC changed to NOT USED*/
define('_msg_UPC','NOT USED');
...
define('_msg_clip','Preview Length');
define('_msg_javascript_clip','This determines the length of the previews generated.  If no value is given the default is 15 intervals.  You can view the intervals in the preview under add new tracks');

/*-----------------------------------------------------------------------------------------------------

Custom Furious Artisans Text

------------------------------------------------------------------------------------------------------*/

define('_msg_currency_info','Prices Shown in US Dollars');
define('_msgDisplayFooter3','You must have JavaScript enabled to checkout.');
