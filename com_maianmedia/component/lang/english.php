...
define( '_msg_publicalbum5','Track Name');
define( '_msg_publicalbum6','Cost');
define( '_msg_publicalbum7','Add to Cart');
define( '_msg_publicalbum8','Add All Tracks to Cart');
...
define('_msg_music','Please click the links to view more information about an album and to preview/purchase tracks. Thank you.');
...
define('_msgDisplayFooter3','_msgDisplayFooter3');
...
------------------------------------------------------------------------------------------------------*/
define('_msg_tools_title','Tools');
define('_msg_manage_items','Manage Physical Items');
define('_msg_items','Physical Items');
define('_msg_product_default','Product');
define('_msg_product_name','Product Name');
define('_msg_product_type','Product Type');
define('_msg_product_image','Product Image');
define('_msg_product_height','Product Height');
define('_msg_product_width','Product Width');
define('_msg_product_image','Product Image');
define('_msg_product_discount','Product Discount');
define('_msg_product_description','Product Description');
define('_msg_product_enable','Enable Product');
define('_msg_product_type_default','Default');
?>
