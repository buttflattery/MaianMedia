...
include_once(dirname(__FILE__).DS.'lang.php');
...
class MaianView extends MaianViewHelper
{
	...
	function displaySearchResults($q_music){
	...
	function displayThankYou($cartData, $MM_PAYPAL ){
		...
		if($this->SETTINGS->show_download == '1'){
			$link = $uri->root().'index.php?option=com_maianmedia&section=download&code='.$cartData->download_code;
